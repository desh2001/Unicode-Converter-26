...
export const convertUnicodeToLegacy = (unicodeText: string): string => {
  ...
  const legacyMap: Record<string, string> = {
    ...
    'ත්ර෩': 'f;%', 'ත්රේ': 'f;a%', 'ත්රෝ': 'f;%da', 'ත්රො': 'f;%d',
    'ත්ර': ';a%',
    ...
    'ඩ්ර෩': 'fv%', 'ඩ්රේ': 'fva%', 'ඩ්රෝ': 'fv%da', 'ඩ්රො': 'fv%d',
    'ඩ්ර': 'va%',

    // බ + Rakaransaya
    'බ්රි': 'ns%', 'බ්රී': 'nS%', 'බ්රා': 'nd%', 'බ්රු': 'nq%', 'බ්රූ': 'nQ%',
    'බ්ර෩': 'fn%', 'බ්රේ': 'fna%', 'බ්රෝ': 'fn%da', 'බ්රො': 'fn%d',
    'බ්ර': 'na%',

    // ෆ + Rakaransaya
    'ෆ්රි': '*s%', 'ෆ්රී': '*S%', 'ෆ්රා': '*d%', 'ෆ්රු': '*q%', 'ෆ්රූ': '*Q%',
    'ෆ්ර෩': 'f*%', 'ෆ්රේ': 'f*a%', 'ෆ්රෝ': 'f*%da', 'ෆ්රො': 'f*%d',
    'ෆ්ර': '*a%',

    // ඝ + Rakaransaya
    'ඝ්රි': '>s%', 'ඝ්රී': '>S%', 'ඝ්රා': '>d%', 'ඝ්රු': '>q%', 'ඝ්රූ': '>Q%',
    'ඝ්ර෩': 'f>%', 'ඝ්රේ': 'f>a%', 'ඝ්රෝ': 'f>%da', 'ඝ්රො': 'f>%d',
    'ඝ්ර': '>a%',

    // ධ + Rakaransaya
    'ධ්රි': 'Os%', 'ධ්රී': 'OS%', 'ධ්රා': 'Od%', 'ධ්රු': 'Oq%', 'ධ්රූ': 'OQ%',
    'ධ්ර෩': 'fO%', 'ධ්රේ': 'fOa%', 'ධ්රෝ': 'fO%da', 'ධ්රො': 'fO%d',
    'ධ්ර': 'Oa%',

    // භ + Rakaransaya
    'භ්රි': 'Ns%', 'භ්රී': 'NS%', 'භ්රා': 'Nd%', 'භ්රු': 'Nq%', 'භ්රූ': 'NQ%',
    'භ්ර෩': 'fN%', 'භ්රේ': 'fNa%', 'භ්රෝ': 'fN%da', 'භ්රො': 'fN%d',
    'භ්ර': 'Na%',

    // ද + Rakaransaya (common)
    'ද්රි': 'os%', 'ද්රී': 'oS%', 'ද්රා': 'od%', 'ද්රු': 'oq%', 'ද්රූ': 'oQ%',
    'ද්ර෩': 'fo%', 'ද්රේ': 'foa%', 'ද්රෝ': 'fo%da', 'ද්රො': 'fo%d',

    // ස + Rakaransaya
    'ස්රි': 'is%', 'ස්රී': 'iS%', 'ස්රා': 'id%', 'ස්රු': 'iq%', 'ස්රූ': 'iQ%',
    'ස්ර෩': 'fi%', 'ස්රේ': 'fia%', 'ස්රෝ': 'fi%da', 'ස්රො': 'fi%d',
    'ස්ර': 'ia%',
